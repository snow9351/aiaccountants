...
DECLARE
  ...
  v_full_name TEXT;
BEGIN
  -- IMPORTANT: This trigger is fired from `auth.users`, so schema-qualify all
  -- references into the public schema to avoid search_path issues on hosted DBs.
...
BEGIN
  ...
  -- Create membership
  INSERT INTO public.company_memberships (org_id, user_id, firm_id, role, invited_by)
